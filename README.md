...
В этом руководстве описаны шаги по развертыванию собственного почтового сервера на **Debian** 12 с использованием [**iRedMail**](https://www.iredmail.org/) и базы данных **MySQL**. Все действия выполняются с правами root или через sudo.
